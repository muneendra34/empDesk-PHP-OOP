    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li><a href="index.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['ress']);}else{$_SESSION['lc']=0;}?><i class="fa fa-angle-left"></i></i>Home</a></li>
          <li><a href="include/usermylogs.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['st']);unset($_SESSION['ut']);}else{$_SESSION['lc']=0;}?><i class="fa fa-angle-left"></i>My Log Details</a></li>
         <li><a href="include/changepassword.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['st']);unset($_SESSION['ut']);}else{$_SESSION['lc']=0;}?><i class="fa fa-angle-left"></i>Change Password</a></li>
          <li><a href="include/logout.php"><i class="fa fa-angle-left"></i>Logout</a></li> </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
      ...
      <div class="content-wrapper">
          ...
          <div class="container"><br>
              <div class="col-lg-8">  <div class="mess2"><h4><?php if(isset($_SESSION['ress'])){ echo "<span class='glyphicon glyphicon-remove'></span>"."&nbsp;&nbsp;".$_SESSION['ress'];}?></h4></div></div>
                 <br> <div class="col-lg-12"><h3>Enter Today Log Entry:</h3></div><br>
                 <br>
