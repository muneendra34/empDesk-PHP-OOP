...
<html>
    ...
    {
    var result = confirm("Are you sure to delete selected Log records?");
    if(result){
        return true;
    }else{
        return false;
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                   ...
                   <li class="dropdown user user-menu">
                    ...
                    <li class="user-footer">
                         <div class="pull-left">
                             <a href="include/profile.php" class="btn btn-default btn-flat">Profile</a>
                         </div>
      ...
      <aside class="main-sidebar">
           ...
           <section class="sidebar">
                ...
                <div class="user-panel">
                 ...
                 <li><a href="include/deleteallusers.php"><i class="fa fa-angle-left"></i>Delete All Users</a></li>
                 <li><a href="include/userslogs.php"><i class="fa fa-angle-left"></i>View Users Logs</a></li>
                 <li><a href="include/dlogs.php"><i class="fa fa-angle-left"></i>Delete All Logs</a></li>
                 <li><a href="include/logout.php"><i class="fa fa-angle-left"></i>Logout</a></li> 
                 </ul>                  
               </section>
      ...
      <div class="content-wrapper">
          <form action="include/deluseractions.php" method="post">     
          <div class="box">
            <div class="box-header with-border">
                ...
                <br>  <br>  <h2 class="box-title">Users List</h2>
                
                <div align="center">
                    <a href="include/useradd.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['err']);}else{$_SESSION['lc']=0;}?><button type="button" class="btn btn-success">Add User</button></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="submit" name="delete" value="Delete User" class="btn btn-danger" onclick="return deleteConfirm(); />
                </div>
            ...
            <?php include 'include/adminusertable.php';?>
          </div>
       </form>
                         <!-- Control Sidebar -->
