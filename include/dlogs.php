  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper"><br>
          ...
          <div class="box" height="200" width="300">
           ...
           <h3>Are you sure to delete All users logs from database ?</h3><br>
           <div class="box-body" >
               <div align="left">  <a href="deletealllogs.php"><button type="button" class="btn btn-primary">Delete All </button></a>
