...
<html>
  ...
  <header class="main-header">
      ...
      <div class="content-wrapper"><br>
          <div><br>
          <div class="box" height="200" width="300">
            <div class="box-header with-border">
           <h3>Are you sure to delete All users and log records from database ?</h3><br>
           <div class="box-body" >
               <div align="left">  <a href="deleteall.php"><button type="button" class="btn btn-primary">Delete All Users</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <a href="../admin.php"><button type="button" class="btn btn-primary">Cancel</button></a></div>
           </div></div></div>               
      <!-- Control Sidebar -->
