  ...
  <header class="main-header">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li><a href="../admin.php"><i class="fa fa-angle-left"></i>Home</a></li>
          <li><a href="deleteallusers.php"><i class="fa fa-angle-left"></i>Delete All Users</a></li>
          <li><a href="userslogs.php"><?php if(!isset($_SESSION['lc'])){$_SESSION['lc']='';} if($_SESSION['lc']==0) {unset($_SESSION['st']);unset($_SESSION['ut']);}else{$_SESSION['lc']=0;}?><i class="fa fa-angle-left"></i>View Users Logs</a></li>
      ...
      <div class="content-wrapper">
          ...
          <form action="delaction.php" method="post" >
          <div class="box">
            <div class="box-header with-border">
                ...
                <br>  <h2 class="box-title">Users List</h2>
                <div align="center">
                    
                    <a href="addlog.php"><button type="button" class="btn btn-success">Add Log</button></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="submit" name="delete"  value="Delete Logs"  onclick="return deleteConfirm();" class="btn btn-danger">    
                </div>
              <div class="box-tools pull-right">
              </div></div>
          <?php include 'logtable.php';?>   
          </div>
